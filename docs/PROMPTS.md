...
1. Dashboard integrity + install (cross-cutting, shared with AG1 who owns apps/dashboard — coordinate, don't duplicate): the demo dashboard must never display fabricated "PROOF VERIFIED" / "SETTLED" / fake explorer-link content as if real. This is a correctness/integrity blocker, not cosmetic — anything not live must be clearly labeled SIMULATED before ANY demo recording.
...
Record your progress and any decisions in docs/status/AG1.md.
