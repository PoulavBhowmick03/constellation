    ...
    <div className="page">
      ...
      <section className="dark-band">
        ...
        <div style={{
          ...
          <span>SkillRegistry: <a href={`https://celoscan.io/address/${CONTRACTS.SkillRegistry}`} target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.7 }}>{truncAddr(CONTRACTS.SkillRegistry)} ↗</a></span>
          <span>x402Escrow: <a href={`https://celoscan.io/address/${CONTRACTS.x402Escrow}`} target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.7 }}>{truncAddr(CONTRACTS.x402Escrow)} ↗</a></span>
          <span>BazaarListings: <a href={`https://celoscan.io/address/${CONTRACTS.BazaarListings}`} target="_blank" rel="noopener noreferrer" style={{ color: 'white', opacity: 0.7 }}>{truncAddr(CONTRACTS.BazaarListings)} ↗</a></span>
        </div>
      </section>
    </div>
  )
